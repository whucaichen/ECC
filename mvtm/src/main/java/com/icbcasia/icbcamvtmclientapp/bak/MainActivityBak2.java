...
public class MainActivityBak2 extends AppCompatActivity {
    ...
    private boolean isLogin, isTexted, isCalled, isDismiss, isExit, isLocate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String lang = getApplicationContext().getSharedPreferences("mVTM", MODE_PRIVATE).getString("language", "zh");
        Log.e(TAG, "onCreate " + lang);
        if (lang.equals("zh")) lang = null;
        Locale locale = setLocate(lang);
        if (locale != null) {
            CFG.locale = locale;
            RES.updateConfiguration(CFG, DM);
            Log.e(TAG, "语言设置已改变: " + CFG.locale);
        }
        ...
        if (getIntent().getBooleanExtra(UPDATE_LANGUAGE, false)) {
            Log.e(TAG, UPDATE_LANGUAGE);
            permitLogin(getIntent().getStringExtra(TAG));
        } else new StartVerify().execute();
    }
    ...
    private void initView() {
        ...
        ll_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityBak2.this);
...
//                }
                if (authVersion != "" && authData != "" && callData != "") {
                    ...
                    if (verify) {
                        ...
                        if (lang == null || lang.equals("")) lang = "zh_cn";
                        return lang;
                    }
                }
            }
        ...
        protected void onPostExecute(Object o) {
            ...
            if (o == null) {
                Log.e(TAG, "URI不合法");
                MainActivityBak2.this.finish();
            } else if (setLocate(o.toString()) != null) {
                Log.e(TAG, "重启语言设置");
                isLocate = true;
                MainActivityBak2.this.finish();
            } else
    ...
    public Locale setLocate(String lang) {
        Locale temp = null;
        if (lang != null && lang != "") {
...
//            RES.updateConfiguration(CFG, DM);
            if (CFG.locale.equals(temp)) {
                getApplicationContext().getSharedPreferences("mVTM", MODE_PRIVATE).edit().remove("language").commit();
                temp = null;
            } else if (temp != null)
                getApplicationContext().getSharedPreferences("mVTM", MODE_PRIVATE).edit().putString("language", lang).commit();
        }
        return temp;
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(MainActivityBak2.this, getString(R.string.ecc_permission), Toast.LENGTH_SHORT).show();
                requestPermissions(new String[]{Manifest.permission.CAMERA}, 1);
            }
        }
    }
    ...
    private void showExitDialog(String title) {
        ...
        isDismiss = true;
        LayoutInflater factory = LayoutInflater.from(MainActivityBak2.this);
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(MainActivityBak2.this);
...
//        if (isCalled) MobileCC.getInstance().releaseCall();
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (isLocate) {
                    Intent it = new Intent(MainActivityBak2.this, MainActivityBak2.class);
                    it.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    it.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    it.putExtra(UPDATE_LANGUAGE, true);
                    it.putExtra(TAG, LOGIN_ID);
                    startActivity(it);
                }
                Log.e(TAG, "onDestroy");
